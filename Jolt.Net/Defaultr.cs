...
namespace Jolt.Net
{
     ...
     */
    public class Defaultr : SpecDriven, ITransform
    {
        ...
        private readonly Key _mapRoot;
        private readonly Key _arrayRoot;
        ...
        public Defaultr(JToken spec)
        {
            ...
            //  Thus we check the top level type of the input.
            {
                ...
                try
                {
                    tempKey = Key.ParseSpec(rootSpec).First();
                }
        ...
        public JToken Transform(JToken input)
        {
            ...
            if (input.Type == JTokenType.Array)
            {
                ...
                _arrayRoot.ApplyChildren(input);
            }
            else
            {
                _mapRoot.ApplyChildren(input);
            }
