...
namespace Jolt.Net.Test
{
    ...
    public class ModifierTest 
    {
        ...
        public void doTest(String testFile, TemplatrTestCase testCase) throws Exception {
            JObject testUnit = JsonUtils.classpathToMap( testFile );
            ...
            if(expected != null) {
                ...
                Object actual = modifier.transform( input, (JObject) context );
        ...
        public void testModifierFirstElementArray() throws IOException {
            JObject input = new HashJObject() {{
                put("input", new Integer[]{5, 4});
            }};

            JObject spec = new HashJObject() {{
                put("first", "=firstElement(@(1,input))");
            }};

            JObject expected = new HashJObject() {{
                put("input", new Integer[]{5, 4});
                put("first", 5);
            }};
