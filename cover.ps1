...
exec { dotnet test `
    ...
    /p:CoverletOutput='../coverage/Jolt.Net.coverage.cobertura.xml' `
    /p:Threshold=80 `
    /p:ThresholdType=branch `
    "Jolt.Net.Test/Jolt.Net.Test.csproj"}
...
$coberturaFiles = "-reports:coverage/Jolt.Net.coverage.cobertura.xml"
